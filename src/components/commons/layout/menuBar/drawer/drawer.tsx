...
import {BulbOutlined, FormOutlined, GithubOutlined, MailOutlined, UserOutlined } from '@ant-design/icons';
...
const MenuDrawer = () => {
  ...
  const items: MenuProps['items'] = [
      getItem('About Me', 'aboutMe', <UserOutlined />, null    
    ),
    ...
    getItem('Contact', 'contact', null, [getItem('E-mail', 'email',<MailOutlined />), getItem('Github', 'github',<GithubOutlined />)], 'group'),
  ];
  return (
    <>
